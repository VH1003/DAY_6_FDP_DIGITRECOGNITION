...
html_temp = """
   ...
   <div class="clearfix">           
   <div class="col-md-12">
   <center><p style="font-size:50px;color:white;margin-top:10px;">Poornima University  </p></center> 
<center><p style="font-size:40px;color:white;margin-top:10px;"> Faculty of Computer Science & Engineering</p></center> 
...
if st.button("About"):
  st.subheader("Developed By: Vishal Harith")
  st.header("Guided By:  Deepak Moud")
...
html_temp = """
   ...
   <div class="clearfix">           
   <div class="col-md-12">
   <center><p style="font-size:20px;color:white;margin-top:10px;">Guided by</p></center> 
